"""
    Fuzzing template for LLCP I

    (c) 2015 Massachusetts Institute of Technology
"""
# define grammar for LLCP I Packet
s_initialize("LLCP Info Packet")
...
# DSAP = 16, PTYPE = 0b1100, SSAP = 32
s_byte(0x83, format="binary", fuzzable=False)
s_byte(0x20, format="binary", fuzzable=False)

s_byte(0x41, format="binary", full_range=True, fuzzable=True)
s_byte(0x41, format="binary", fuzzable=True)

self.add_protocol_struct("LLCP Info Packet")
