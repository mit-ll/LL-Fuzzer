"""
    Fuzzing template for NDEF strings

    (c) 2015 Massachusetts Institute of Technology
"""
# define grammar for NDEF Record
s_initialize("NDEF String")
...
if s_block_start("payload block"):
    s_size("lang code", name="lang code len", format="binary", length=1, fuzzable=False)
...
self.add_protocol_struct("NDEF String")
